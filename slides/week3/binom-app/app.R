...
.card > .form-group { height:98px; flex:none; overflow:hidden; }
.hdr { height:24px; flex:none; }
.key { height:18px; flex:none; }
.fit { display:flex; gap:18px; font-size:12px; color:#777; margin:8px 0 4px 0; }
#fit_control, #fit_treated { height:32px; flex:none; }
