...
-  We can construct random variables as functions other random variables!
  ...
  - The probability that the respondent has an income between **£50,000 and £100,000** is just 
    ...
    $$P(50{,}000 \le R \cdot X_i \le 100{,}000)$$

  - $R \cdot X_i$ is itself another random variable!
...
- The **2012 Mexico Panel Study** used a **list experiment** to measure vote buying in the 2012 presidential election
...
mexico <- read_dta("data/2012_stata.dta") |>
  mutate(treat  = case_when(w2_P35C == 1 ~ 0, w2_P35C == 2 ~ 1),
         y      = as.numeric(if_else(treat == 0, w2_P35A, w2_P35B)),
...
::: {.attribution}
2012 Mexico Panel Study, Wave 2
:::
