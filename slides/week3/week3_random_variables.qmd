...
- Beyond the expectation, there are other summaries of a distribution that capture other relevant features.
  - We may want to know how **spread out** realizations of the random variable are around the mean.
- The **variance** of a random variable $\Var(X)$ is defined as the expected **squared** deviation from $\mathbb{E}[X]$
