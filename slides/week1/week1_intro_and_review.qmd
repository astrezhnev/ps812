...
- An **event** is a **subset** of the sample space (including the empty set)
  - We'll denote the set of all events that can be assigned a probability as $\mathcal{F}$ (this is called the "$\sigma$-algebra")
...
- The **intersection** of two events $A \cap B$ contains all elements **both** in $A$ **and** $B$
  - Same idea for notation $\displaystyle\bigcap_{i=1}^N$ to denote an intersection over *many* events 
...
- Probability is a function that maps from $\mathcal{F}$ to the real numbers.
...
- 58% of respondents **incorrectly** said the **second** option
  - Let's prove *why* this is incorrect using the axioms of probability!
  - We'll **bound** $P(A \cap B)$ in terms of $P(A)$ and $P(B)$
...
- We have $P(A) + P(B)$...but what about $P(A \cup B)$
  - $A \cup B \subseteq \mathcal{S}$ and $P(\mathcal{S}) = 1$. So $P(A \cup B) \leq 1$
